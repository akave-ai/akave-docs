...
{{< callout type="info" >}}
The maximum file size for a single `akavecli` upload is **5 GB**.  
For larger objects, use **Multipart Uploads** with the [Akave O3 API](/akave-o3/multipart-uploads/best-practices-for-large-files/).
{{< /callout >}}
