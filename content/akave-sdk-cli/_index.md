...
{{< callout type="info" >}}
  The preferred method of storing data on the Akave network is by using the [blockchain Integrated storage network and API](https://docs.akave.xyz/akave-sdk-cli/blockchain-integrated/).
{{< /callout >}}
